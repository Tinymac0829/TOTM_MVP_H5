...
| ENG-05 | IN_PROGRESS | `R-012,R-013,R-015` | Implement minimal gameplay UI | Start, fail, clear, restart, and replay flows are visible and usable; in principle this task must not be marked `DONE` before `ENG-04` is validated and marked `DONE` |
